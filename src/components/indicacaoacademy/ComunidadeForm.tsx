...
export function ComunidadeForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Reusa COMUNIDADE_FORM_SUBMIT_SUCCESS pra não inflar inventário
      // de eventos — a separação entre /comunidade e /indicacaoacademy
      // é feita pelo `source` acima e pelo content_name do Meta Pixel.
      trackEvent(EVENTS.COMUNIDADE_FORM_SUBMIT_SUCCESS);

      // Meta Pixel — evento Lead identificado como lp_indicacao_academy
      // pra Mari criar Custom Conversion separada no Events Manager.
      trackMetaEvent("Lead", {
