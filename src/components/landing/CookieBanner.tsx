...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-2xl rounded-2xl border border-[var(--border)] bg-[var(--offwhite)]/95 p-4 shadow-[0_30px_80px_-30px_rgba(13,13,13,0.25)] backdrop-blur md:left-auto md:right-6">
